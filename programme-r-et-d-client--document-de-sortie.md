...
- "Génère un tableau en markdown, listant les domaines scientifiques en lignes, et la principale thématique de recherche en colonne, intitulée "Thématique : ". Suis ceci avec une colonne "Besoin de R&D ?". Pour chaque domaine, formule un bref descriptif dans la case correspondante, évaluant les contributions escomptées à la thématique, signifiant l'importance de ces apports, l'état des solutions existantes, les obstacles technologiques à franchir, et l'état général actuel des travaux. Si l'état actuel suggère un blocage qui nécessite des actions de R&D, indique dans la case suivante "Besoin de R&D". Dans le cas contraire, signale par "PAS DE BESOIN DE R&D" en lettres capitales."
