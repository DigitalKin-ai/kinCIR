...
- "Génère un tableau structuré en markdown, avec les domaines scientifiques listés en lignes, et la première thématique de recherche en colonne, étiquetée "Thématique : ". Cela sera suivi d'une colonne intitulée "Besoin de R&D ?". Pour chaque domaine scientifique, rédige dans la case correspondante un descriptif précis concernant les avantages escomptés de ce domaine pour la thématique de recherche, la pertinence de ces contributions, les solutions et connaissances déjà en place, les obstacles technologiques persistants ainsi que l'état actuel de la recherche dans ce domaine. Dans l'hypothèse où l'état actuel indique une barrière significative, saisis dans la cellule suivante le terme "Besoin de R&D". À l'inverse, si l'état des travaux ne requiert pas de recherche et développement supplémentaire, note dans la case appropriée le terme "Pas de besoin de R&D", en majuscules."
